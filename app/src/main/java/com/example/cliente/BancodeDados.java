...
public class BancodeDados extends SQLiteOpenHelper {
    ...
    public void onCreate(SQLiteDatabase db) {
        ...
        String query2;
        query2 = "CREATE TABLE IF NOT EXISTS ContaLanchonete (IdConta INTEGER PRIMARY KEY AUTOINCREMENT, IdCli INTEGER, DataAbertura TEXT DEFAULT (datetime('now')), valorTotal REAL NOT NULL, FOREIGN KEY (IdCli) REFERENCES Cliente(IdCli))";
        db.execSQL(query2);
    ...
    public void insertContaLanchonete(ContaLanchonete contalanchonete) {
        ...
        db.insert("ContaLanchonete", null ,values);

        db.close();
    }

    public void insertItensConta(ItensConta itensConta) {
        SQLiteDatabase db = this.getWritableDatabase();
        ContentValues values = new ContentValues();
        ...
        db.insert("ItensConta", null, values);
